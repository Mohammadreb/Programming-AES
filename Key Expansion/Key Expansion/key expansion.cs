...
namespace Key_Expansion
{
    ...
    public partial class Form1 : Form
    {
        ...
        private static byte[] result = new byte[16];//resualt size
       ...
       private static void arraykey(int round)
        {
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
        ...
        {
            byte[] l = StringToByteArray(keytxt.Text);
